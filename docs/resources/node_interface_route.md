...
page_title: "tg_node_interface_route Resource - terraform-provider-tg"
subcategory: ""
description: |-
  Manage a static route on a node or cluster network interface.
---

# tg_node_interface_route (Resource)
